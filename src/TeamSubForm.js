        ...
        <div className="TeamSubForm">
            ...
            <div className="TournamentForm-number-container">
                <FormGroup className="TournamentForm-number-group">
                    ...
                    <Input className="TournamentForm-number-input" type="number" name="teamSize" value={formData.teamSize} autoComplete="off" min={2} max={10} required onChange={handleChange} />
                </FormGroup>
                <FormGroup className="TournamentForm-number-group">
                    <Label className="TournamentForm-team-label">Number of teams: <span className="TournamentForm-team-count">{parseInt(parseInt(formData.minPlayers) / parseInt(formData.teamSize))}-{parseInt(parseInt(formData.maxPlayers) / parseInt(formData.teamSize))}</span></Label>
                </FormGroup>
                <FormGroup className="TournamentForm-number-group">
                    <Label>Minimum entries:</Label>{' '}
                    <Input className="TournamentForm-number-input" type="number" name="minPlayers" value={formData.minPlayers} autoComplete="off" min={parseInt(formData.teamSize * 3)} max={parseInt(formData.maxPlayers) - 1} step={parseInt(formData.teamSize)} required onChange={handleChange} />
                </FormGroup>
                <FormGroup className="TournamentForm-number-group">
                    <Label>Number of rounds:</Label>{' '}
                    <Input className="TournamentForm-number-input" type="number" name="rounds" value={formData.rounds} autoComplete="off" min={1} max={parseInt(parseInt(formData.minPlayers) / parseInt(formData.teamSize)) - 1} required onChange={handleChange} />
                </FormGroup>
                <FormGroup className="TournamentForm-number-group">
                    <Label>Maximum entries:</Label>{' '}
                    <Input className="TournamentForm-number-input" type="number" name="maxPlayers" value={formData.maxPlayers} autoComplete="off" min={parseInt(formData.minPlayers) + parseInt(formData.teamSize)} max={100} required onChange={handleChange} step={parseInt(formData.teamSize)} />
                </FormGroup>
                <FormGroup className="TournamentForm-number-group">
